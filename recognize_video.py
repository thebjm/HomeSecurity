...
script = os.path.join(BASE_DIR, 'run_2.py')
...
embedding_model = os.path.join(BASE_DIR,'face_detection_model/nn4.small2.v1.t7')
...
while True:
        ...
        for i in range(0, detections.shape[2]):
                ...
                if confidence > 0.5:
                        ...
                        print(type(la))
                        print (la)
                        #sql = """ select id from 'visitors_details' where 'name' =  """
                        mycursor.execute(" select * from visitors_details where name = %s ",(la, )      )
                        #mycursor.execute(sql, la)
                        ...
                        if (int(len(result)) > 0):
                                ...
                                time.sleep(0.5)
                                subprocess.call('python3 ' +script, shell = True )
